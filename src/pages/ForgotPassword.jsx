...
function ForgotPassword() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL ?? (import.meta.env.PROD ? "" : "http://localhost:5000")}`}/api/auth/forgot-password`, {
        method: "POST",
